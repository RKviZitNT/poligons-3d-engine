...
Vec3d::Vec3d() : x(0.f), y(0.f), z(0.f), w(0.f) {}
Vec3d::Vec3d(float x_, float y_, float z_) : x(x_), y(y_), z(z_), w(0.f) {}
...
Vec3d Vec3d::vecProd(const Vec3d& v) const { return Vec3d(y * v.z - z * v.y, z * v.x - x * v.z, x * v.y - y * v.x); }
